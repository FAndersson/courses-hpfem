...
from dolfin import Point, cells, facets, refine, MeshFunction, SubDomain, as_vector
...
from dolfin.functions import (
    FunctionSpace, VectorFunctionSpace, TestFunction, TestFunctions, Function, TrialFunctions,
    Expression, CellSize, FacetNormal)
from mshr import Circle, Rectangle, generate_mesh
from ufl import dx, ds, inner, grad, sqrt, div, VectorElement, FiniteElement, Measure
...
def solve_navier_stokes_equation(interior_circle=False, num_mesh_refinements=2):
    """
